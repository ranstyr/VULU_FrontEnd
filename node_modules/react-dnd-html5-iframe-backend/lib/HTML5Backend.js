...
var HTML5Backend = (function () {
  ...
  HTML5Backend.prototype.setup = function setup() {
    ...
    window.frames[0].addEventListener('dragstart', this.handleTopDragStart);
    window.frames[0].addEventListener('dragstart', this.handleTopDragStartCapture, true);
    window.frames[0].addEventListener('dragend', this.handleTopDragEndCapture, true);
    window.frames[0].addEventListener('dragenter', this.handleTopDragEnter);
    window.frames[0].addEventListener('dragenter', this.handleTopDragEnterCapture, true);
    window.frames[0].addEventListener('dragleave', this.handleTopDragLeaveCapture, true);
    window.frames[0].addEventListener('dragover', this.handleTopDragOver);
    window.frames[0].addEventListener('dragover', this.handleTopDragOverCapture, true);
    window.frames[0].addEventListener('drop', this.handleTopDrop);
    window.frames[0].addEventListener('drop', this.handleTopDropCapture, true);
  };
  ...
  HTML5Backend.prototype.teardown = function teardown() {
    ...
    window.frames[0].removeEventListener('dragstart', this.handleTopDragStart);
    window.frames[0].removeEventListener('dragstart', this.handleTopDragStartCapture, true);
    window.frames[0].removeEventListener('dragend', this.handleTopDragEndCapture, true);
    window.frames[0].removeEventListener('dragenter', this.handleTopDragEnter);
    window.frames[0].removeEventListener('dragenter', this.handleTopDragEnterCapture, true);
    window.frames[0].removeEventListener('dragleave', this.handleTopDragLeaveCapture, true);
    window.frames[0].removeEventListener('dragover', this.handleTopDragOver);
    window.frames[0].removeEventListener('dragover', this.handleTopDragOverCapture, true);
    window.frames[0].removeEventListener('drop', this.handleTopDrop);
    window.frames[0].removeEventListener('drop', this.handleTopDropCapture, true);
  ...
  HTML5Backend.prototype.setCurrentDragSourceNode = function setCurrentDragSourceNode(node) {
    ...
    window.frames[0].addEventListener('mousemove', this.endDragIfSourceWasRemovedFromDOM, true);
  };
  ...
  HTML5Backend.prototype.clearCurrentDragSourceNode = function clearCurrentDragSourceNode() {
    if (this.currentDragSourceNode) {
      ...
      this.currentDragSourceNodeOffsetChanged = false;
      window.frames[0].removeEventListener('mousemove', this.endDragIfSourceWasRemovedFromDOM, true);
      return true;
    }
